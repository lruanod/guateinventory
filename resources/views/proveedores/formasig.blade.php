...
@section('title', 'proveedores asignar producto')
@section('content')
  ...
  @endif
    ...
    <div class="col-md-12 mt-3">
        ...
        <div class="card" style="background: linear-gradient(to bottom, #3C3E40  , #07459F );" >
            <h4 class="text-center text-white">Asignación de producto a proveedor</h4>
        </div>
        ...
        <!--fin error -->
            <div class=" row justify-content-center">
                <div class="card" style="background: linear-gradient(to bottom, #3C3E40  , #1B92F0 );">
                    ...
                    <form action="{{url('/savedetap')}}" method="post">
                        @csrf
                        <div class="card-body">
                            ...
                            <input type="hidden" name="proveedore_id" value="{{$proveedore->id}}">
                            <div class="row form-group">
                                <label for="nombre" class="col-5 text-white">Proveedor</label>
                                <input type="text" name="nombre"  class="form-control col-md-7" value="{{$proveedore->nombre}}" readonly="readonly" >
                            </div>

                            <div class="row form-group">
                                <label for="direccion" class="col-5 text-white">Dirección</label>
                                <input type="text" name="direccion"  class="form-control col-md-7" value="{{$proveedore->direccion}}"  readonly="readonly" >
                            </div>

                            <div class="row form-group">
                                <label for="tel" class="col-5 text-white">Teléfono</label>
                                <input type="text" name="tel"  class="form-control col-md-7" value="{{$proveedore->tel}}"  readonly="readonly" >
                            </div>
                                ...
                                <div class="form-group">
                                    <div class="card" style="background: linear-gradient(to bottom, #3C3E40  , #1B92F0 );">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <form  method="get"  action="{{route('form_productoasig',$proveedore->id)}}">
                                                    <div class="row form-group">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <a href="{{route('form_productoasig',$proveedore->id)}}" class="btn btn-warning text-white col-md-4" title="todos los registros">
                                    ...
                                    <table class="table table-striped table-responsive">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{route('form_productoasig',$proveedore->id)}}" method="get">
