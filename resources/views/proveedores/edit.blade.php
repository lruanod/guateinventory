...
@section('content')
    ...
    <div class="col-md-12 mt-3">
        ...
        <div class="card" style="background: linear-gradient(to bottom, #3C3E40  , #07459F );" >
            <h4 class="text-center text-white">Editar proveedores</h4>
        </div>
        ...
        <!--fin error -->
            <div class=" row justify-content-center">
                <div class="card" style="background: linear-gradient(to bottom, #3C3E40  , #1B92F0 );">
                    <form action="{{route('edit_proveedore',$proveedore->id)}}" method="post">
                        @csrf @method('PATCH')
                        ...
                        <div class="card-body">
                            ...
                            <div class="row form-group">
                                ...
                                <input type="text" name="nombre" value="{{$proveedore->nombre}}" class="form-control col-md-7" >
                            </div>

                            <div class="row form-group">
                                <label for="direccion" class="col-5 text-white">Dirección</label>
                                <input type="text" name="direccion" value="{{$proveedore->direccion}}" class="form-control col-md-7" >
                            </div>

                            <div class="row form-group">
                                <label for="tel" class="col-5 text-white">Teléfono</label>
                                <input type="text" name="tel" value="{{$proveedore->tel}}"  class="form-control col-md-7" >
                            </div>
