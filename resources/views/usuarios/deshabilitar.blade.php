...
@section('content')
    <div class="col-md-12 mt-3">
        ...
        <div class="card" style="background: linear-gradient(to bottom, #3C3E40  , #07459F );" >
            <h4 class="text-center text-white">Deshabilitar usuarios</h4>
        </div>
        ...
        <!--fin error -->
            <div class=" row justify-content-center">
                <div class="card" style="background: linear-gradient(to bottom, #3C3E40  , #1B92F0 );">
                    <form action="{{route('des_usuario',$usuario->id)}}" method="post">
                        @csrf @method('PATCH')
                        ...
                        <div class="card-body">
                            ...
                            <div class="row form-group">
                                ...
                                <input type="text" name="nombre" value="{{$usuario->nombre}}" class="form-control col-md-7" readonly="readonly">
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <input type="text" name="direccion" value="{{$usuario->direccion}}" class="form-control col-md-7" readonly="readonly">
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <select class="form-control col-md-7" name="rol" readonly="readonly">
                            ...
                            <div class="row form-group">
                                ...
                                <input type="number" name="cui" value="{{$usuario->cui}}" class="form-control col-md-7" readonly="readonly">
                            </div>

                            <div class="row form-group">
                                <label for="tel" class="col-5 text-white">Tel</label>
                                <input type="text"  placeholder="+502 56271490" name="tel" value="{{$usuario->tel}}" class="form-control col-md-7" readonly="readonly">
                            </div>
