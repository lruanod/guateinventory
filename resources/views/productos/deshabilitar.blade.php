        ...
        <!--fin error -->
            <div class=" row justify-content-center">
                <div class="card" style="background: linear-gradient(to bottom, #3C3E40  , #1B92F0 );">
                    <form action="{{route('des_producto',$producto->id)}}" method="post">
                        @csrf @method('PATCH')
                        ...
                        <div class="card-body">
                            ...
                            <div class="row form-group">
                                ...
                                <input type="number" name="descuento"  value="{{$producto->descuento}}" readonly="readonly" placeholder="0.00"  min="0" step="0.01" pattern="^\d+(?:\.\d{1,2})?$" onblur="this.parentNode.parentNode.style.backgroundColor=/^\d+(?:\.\d{1,2})?$/.test(this.value)?inherit':'red'" class="form-control col-md-7">
                            </div>
